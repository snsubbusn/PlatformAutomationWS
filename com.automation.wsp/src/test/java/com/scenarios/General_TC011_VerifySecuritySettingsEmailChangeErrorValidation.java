...
public class General_TC011_VerifySecuritySettingsEmailChangeErrorValidation extends Action_Method
{

	public void preferenceAndSecurity() throws Exception
	{

		logger = extent.startTest("General_TC011_VerifySecuritySettingsEmailChangeErrorValidation");
		driver.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
		logger.assignAuthor("Natasha");
		logger.assignCategory("General");
		logger.setDescription("Login with any WS user and click on ‘Settings’. Verify a new tab is opened and navigate to the new tab. Navigate to Security Settings and click on Change Email. Enter the details and validate error messages. Log out and close the browser");
		...
		if(sp.VerifyEmailErrors())
		{
			logger.log(LogStatus.INFO,"Entered invalid data in email and OTP field to verify the errors");
