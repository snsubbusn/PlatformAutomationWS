...
public class TC_016_Create_Save_Corporate_Profile extends Action_Method {
	...
	public void VerifyEditandSaveCorporateCompanyProfilePage() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		...
		if(prof2.verifyLocationsPresent()) {
			...
			String loc = prof2.addNewOfficeLocation();
		...
		if(!nam.isEmpty()) {
			logger.log(LogStatus.PASS, "Corporate Profile successfully edited and the profile page is displayed. The name of the company displayed in profile page is - "+nam);
		}else {
