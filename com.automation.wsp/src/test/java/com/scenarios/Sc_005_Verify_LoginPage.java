...
public class Sc_005_Verify_LoginPage extends Action_Method
{
	public void Verify_all_elements_present_in_loginPage()
	{
		...
		logger = extent.startTest("Verifying all elements and text present in Login page");
		...
		wait_for_pageload(Variables.url);
				...
				logger.log(LogStatus.INFO, "Verify all elements,texts present in login page");
