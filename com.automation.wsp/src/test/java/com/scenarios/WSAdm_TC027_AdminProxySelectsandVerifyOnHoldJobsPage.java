...
public class WSAdm_TC027_AdminProxySelectsandVerifyOnHoldJobsPage extends Action_Method {
	...
	public void verifyOnHoldjobsPageofProxy() throws InterruptedException {
		...
		logger.setDescription("WS Admin Logs in and click on proxy and verify the proxy page and clicks on any proxy corporate card and navigates to On-Hold jobs page, gets the first On-Hold job card details sort by `updated Date` `Posted Date` and `Title`.");
