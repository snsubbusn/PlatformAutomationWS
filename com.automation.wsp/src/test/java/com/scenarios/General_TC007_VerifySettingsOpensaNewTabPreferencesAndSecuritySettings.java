...
public class General_TC007_VerifySettingsOpensaNewTabPreferencesAndSecuritySettings extends Action_Method
{

	public void preferenceAndSecurity() throws Exception
	{
		
		logger = extent.startTest("General_TC007_VerifySettingsOpensaNewTabPreferencesAndSecuritySettings");
		driver.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
		logger.assignAuthor("Natasha");
		logger.assignCategory("General");
		logger.setDescription("Login with any WS user and click on ‘Settings’. Verify a new tab is opened and navigate to the new tab. Verify the Sections present in the new tab. Log out and close the browser.");
