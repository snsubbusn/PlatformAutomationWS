...
public class Agent_TC017_VerifyAgencyPartnerAbletoViewJobDetailsfromClosedAssignment extends Action_Method{

	public void verifyAgencyPartnerAbletoViewJobDetailsfromClosedAssignment() throws InterruptedException {
		logger = extent.startTest("Agent_TC017_VerifyAgencyPartnerAbletoViewJobDetailsfromClosedAssignment");
		logger.assignAuthor("Sivaprakash");
		logger.assignCategory("Agency Partner General");
		logger.setDescription("Agency Logs in and click on \"Closed Assignments\" tab. Verify under Closed Assignments any job is present. If present click on first job to view the Job Details");
		...
		if(my.click_On_ClosedAssignment()) {
			logger.log(LogStatus.PASS, "Navigated to \"Closed Assignments\" Page");
			...
			logger.log(LogStatus.FAIL, "Failed to navigate to \"Closed Assignments\" Page");
		}

		logger.log(LogStatus.INFO, "Completed verification of job details of the first job card in \"Closed Assignments\" page");
