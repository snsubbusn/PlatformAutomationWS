...
public class Agent_TC024_VerifySearchResultsForNameFilterandTagCandidate extends Action_Method{

	public void verifySearchResultsForNameFilterandTagCandidate() throws InterruptedException {
		logger = extent.startTest("Agent_TC024_VerifySearchResultsForNameFilterandTagCandidate");
		logger.assignAuthor("Sivaprakash");
		logger.assignCategory("Agency Partner General");
		logger.setDescription("Agency Logs in and click on \"Active Assignments\" tab. Verify Jobs present under Active Assignments and click on 'Assign Candidates'. Click on \"Tag Existing\" Tab and search with Name filters");
		...
		if(my.click_On_ActiveAssignmentTab()) {
			...
			logger.log(LogStatus.INFO, "Verify the no of results for Search with Name Filters applied");
			my.searchForNameFilter();
		...
		logger.log(LogStatus.INFO, "Completed Verifying searching Tag Existing with Name filters");
