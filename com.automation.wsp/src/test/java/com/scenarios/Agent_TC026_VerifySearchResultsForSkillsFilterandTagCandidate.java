...
public class Agent_TC026_VerifySearchResultsForSkillsFilterandTagCandidate extends Action_Method{

	public void verifySearchResultsForSkillsFilterandTagCandidate() throws InterruptedException {
		logger = extent.startTest("Agent_TC026_VerifySearchResultsForSkillsFilterandTagCandidate");
		logger.assignAuthor("Sivaprakash");
		logger.assignCategory("Agency Partner General");
		logger.setDescription("Agency Logs in and click on \"Active Assignments\" tab. Verify Jobs present under Active Assignments and click on 'Assign Candidates'. Click on \"Tag Existing\" Tab and search with Skills filters");
		...
		if(my.click_On_ActiveAssignmentTab()) {
			...
			logger.log(LogStatus.INFO, "Verify the no of results for Search with Skills Filters applied");
			my.searchForSkillsFilter();
		...
		logger.log(LogStatus.INFO, "Completed Verifying searching Tag Existing with Skills filters");
