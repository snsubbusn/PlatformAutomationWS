...
public class Agent_TC027_VerifySearchResultsForExperienceFilterandTagCandidate extends Action_Method{

	public void verifySearchResultsForExperienceFilterandTagCandidate() throws InterruptedException {
		logger = extent.startTest("Agent_TC027_VerifySearchResultsForExperienceFilterandTagCandidate");
		logger.assignAuthor("Sivaprakash");
		logger.assignCategory("Agency Partner General");
		logger.setDescription("Agency Logs in and click on \"Active Assignments\" tab. Verify Jobs present under Active Assignments and click on 'Assign Candidates'. Click on \"Tag Existing\" Tab and search with Experience filters");
		...
		if(my.click_On_ActiveAssignmentTab()) {
			...
			logger.log(LogStatus.INFO, "Verify the no of results for Search with Experience Filters applied");
			
			my.searchForExperienceFilter();
		...
		logger.log(LogStatus.INFO, "Completed Verifying searching Tag Existing with Experience filters");
