...
public class TC_003_Verify_Corporate_Company_Edit_OfficeLocations_Solutions_offered extends Action_Method {
	
	public void Verify_Company_OfficeLocations() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
	...
	if(profile2.Verify_Edit_Office_Locations_Section()==true)
	{
		...
		logger.log(LogStatus.PASS, "Office Location updated successfully");
	}
	else{
